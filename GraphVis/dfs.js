class DFSVisualization {
    ...
    start() {
        ...
        this.traverseDFS("node1");
    }

    async traverseDFS(nodeId) {
        if (!this.isRunning || this.visitedNodes.has(nodeId)) return;
        ...
        for (let edge of neighbors) {
            ...
            // Step 4: Traverse to the neighbor node
            await this.traverseDFS(neighborId);
        }
    }
...
// Initialize DFS visualization instance
const visualization = new DFSVisualization();
